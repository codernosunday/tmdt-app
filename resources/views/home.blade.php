                ...
                <div class="swiper-slide py-5">
                    <div class="row banner-content align-items-center">
                        ...
                        <div class="content-wrapper col-md-7 p-5 mb-5">
                            <div class="secondary-font text-primary text-uppercase mb-4">Giảm ngay 10 - 20%</div>
                            <h2 class="banner-title display-1 fw-normal">Điểm đến lý tưởng cho <span
                                    class="text-primary">thú cưng</span> của bạn</h2>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="images/item1.jpg" class="img-fluid rounded-4"
                                    alt="image"></a>
        ...
        <div class="row my-5 py-5">
            <div class="offset-md-3 col-md-6 my-5">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        <input type="password" class="form-control form-control-lg" name="confirm_password" id="password2"
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card-text">
                            <p class="blog-paragraph fs-6">
                                Cốt lõi trong hoạt động của chúng tôi là ý tưởng rằng các thành phố là nơi ươm mầm cho những thành tựu vĩ đại nhất của con người và là hy vọng lớn nhất cho một tương lai bền vững.
                            </p>
