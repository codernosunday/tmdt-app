@vite(['resources/scss/themsanphamadmin.scss', 'resources/js/adminscript/qlsanpham.js'])
    ...
    <div class="product-edit-container">
        ...
        <form id="productForm">
            ...
            <div class="form-grid">
                ...
                <div class="form-column">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="anh" name="anh">
                    </div>
                    <div class="form-group">
            ...
            <div class="form-actions">
                <button type="button" onclick="sendData()" class="btn-submit">Thêm mới</button>
