...
@section('content')
    ...
    <section id="foodies" class="my-5">
        <div class="container my-5 py-5">
            ...
            <div class="section-header d-md-flex justify-content-between align-items-center">
                <h2 class="display-3 fw-normal">Đồ dùng văn phòng phẩm</h2>
                <div>
    ...
    @include('components.banner-sale')
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-10 mt-md-5 p-5 pt-0 pt-md-5">
                                        <p class="testimonial-content fs-2">
                                            📢 Văn phòng gọn gàng – Công việc suôn sẻ! 🖊📒✂️</br>
                                            💼 Bút, sổ tay, giấy in, kẹp tài liệu hay bất kỳ dụng cụ văn phòng nào?
                                            Chúng tôi có đủ! 🎯</br>
                                            🔥 Giá tốt – Giao nhanh – Chất lượng đảm bảo 🔥 </br>
                                            📞 Mua ngay để nhận ưu đãi hấp dẫn! 🚀
                                        </p>
                                        <p class="text-black">- Shopen</p>
                                    </div>
                                </div>
                            </div>
                        </div>
