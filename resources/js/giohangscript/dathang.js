    ...
    fetch('/dathang/magiamgia', {
        ...
        .then(data => {
            if (data.dieukien) {
                ...
                window.appData.tongTienGoc = parseInt(window.appData.tongTienGoc) - parseInt(data.giasale);
                const tong = new Intl.NumberFormat('vi-VN').format(window.appData.tongTienGoc) + ' đ';
